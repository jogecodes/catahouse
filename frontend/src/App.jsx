      ...
      <div className="min-h-screen bg-gradient-to-b from-sky-50 to-white text-gray-800">
        <header className="sticky top-0 z-10 backdrop-blur bg-white/70 border-b border-slate-200">
          <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
            <h1 className="text-xl font-semibold tracking-tight">CataHouse - Valoraciones</h1>
            <div className="flex items-center gap-2">
              ...
              <nav className="hidden md:flex gap-2">
                ...
                <Link className="px-3 py-1.5 rounded-md hover:bg-slate-100 text-slate-700 border border-slate-200" to="/rate">Valorar ítems</Link>
                <Link className="px-3 py-1.5 rounded-md hover:bg-slate-100 text-slate-700 border border-slate-200" to="/synthesis">Síntesis</Link>
              </nav>
            </div>
          </div>
          {open && (
            <div className="md:hidden border-t border-slate-200">
              <nav className="max-w-5xl mx-auto px-4 py-3 flex flex-col gap-2">
                ...
                <Link onClick={() => setOpen(false)} className="px-3 py-2 rounded-md hover:bg-slate-100 text-slate-700 border border-slate-200" to="/rate">Valorar ítems</Link>
                <Link onClick={() => setOpen(false)} className="px-3 py-2 rounded-md hover:bg-slate-100 text-slate-700 border border-slate-200" to="/synthesis">Síntesis</Link>
              </nav>
            </div>
          )}
        </header>
